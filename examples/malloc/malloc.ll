...
@.str = private unnamed_addr constant [21 x i8] c"klee_is_symbolic(p1)\00", align 1
@.str.1 = private unnamed_addr constant [9 x i8] c"malloc.c\00", align 1
@__PRETTY_FUNCTION__.main = private unnamed_addr constant [11 x i8] c"int main()\00", align 1
@.str.2 = private unnamed_addr constant [22 x i8] c"klee_is_symbolic(pp1)\00", align 1
...
define dso_local i32 @main() #0 {
  ...
  %7 = getelementptr inbounds i32, i32* %6, i64 99
  store i32* %7, i32** %3, align 8
  %8 = load i32*, i32** %2, align 8
  store i32 100, i32* %8, align 4
  %9 = load i32*, i32** %2, align 8
  %10 = ptrtoint i32* %9 to i64
  %11 = call i32 @klee_is_symbolic(i64 %10)
  %12 = icmp ne i32 %11, 0
...
14:                                               ; preds = %0
  call void @__assert_fail(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 35, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #5
  unreachable

15:                                               ; preds = %13
  %16 = load i32*, i32** %3, align 8
  %17 = ptrtoint i32* %16 to i64
  %18 = call i32 @klee_is_symbolic(i64 %17)
  %19 = icmp ne i32 %18, 0
...
21:                                               ; preds = %15
  call void @__assert_fail(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i64 0, i64 0), i32 36, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @__PRETTY_FUNCTION__.main, i64 0, i64 0)) #5
  unreachable
...
declare dso_local i32 @klee_is_symbolic(i64) #2
