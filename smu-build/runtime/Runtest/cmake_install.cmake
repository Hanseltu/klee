# Install script for directory: /home/haoxin/haoxin-data/smu-research/klee/runtime/Runtest
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/haoxin/haoxin-data/smu-research/klee/smu-build/lib/libkleeRuntest.so.1.0")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libkleeRuntest.so.1.0" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libkleeRuntest.so.1.0")
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/haoxin/haoxin-data/smu-research/klee/smu-build/lib/libkleeRuntest.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libkleeRuntest.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libkleeRuntest.so")
    if(CMAKE_INSTALL_DO_STRIP)
